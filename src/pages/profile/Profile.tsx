                ...
                <CardContent>
                    <div className="flex flex-col md:flex-row gap-6">
                        ...
                        <div className="flex-1 space-y-4">
                            ...
                            {currentUser.userType === 'manager' && managerData && (
                                <ManagerDetails manager={managerData} />
                            )}
                            {currentUser.userType === 'admin' && (
                                <AdminDetails admin={currentUser} />
                            )}
                        </div>
                    </div>
                </CardContent>
...
function DetailItem({ icon: Icon, label, value, valueColor = 'text-foreground' }: { icon: any, label: string, value: string, valueColor?: string }) {
    return (
