...
export function useOrders(limit: number = 10, completedOrders = false) {
  ...
  return {
    ...
    resetFilters,
    filterMetadata,
    changeOrderStatus: changeStatusMutation.mutateAsync,
    changeBulkOrderStatus: changeBulkOrderStatusMutation.mutateAsync,
    deleteOrder: deleteOrderMutation.mutateAsync,
    deleteBulkOrders: deleteBulkOrdersMutation.mutateAsync,
