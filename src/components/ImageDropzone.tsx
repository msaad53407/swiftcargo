    ...
    <div className="space-y-4">
      ...
      >
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-1">Supports: JPG, JPEG, PNG, WEBP</p>
        </div>
      </div>

      {value && (
        <div className="relative aspect-square rounded-lg overflow-hidden border bg-muted w-full max-w-[200px]">
          <img src={value} alt="Preview" className="h-full w-full object-cover transition-all hover:scale-105" />
        </div>
      )}
    </div>
  );
